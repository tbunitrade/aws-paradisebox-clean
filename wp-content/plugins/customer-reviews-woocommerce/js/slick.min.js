...
(function() {
	function initReviewSliders(scope) {
		var root = jQuery(scope || document);
		root.find('.cr-reviews-slider').each(function() {
			var slider = jQuery(this);
			if (slider.hasClass('slick-initialized')) {
				return;
			}
			if (typeof slider.slickk === 'function') {
				slider.slickk();
			}
		});
	}
	// initialize slider on normal pages
	jQuery(document).ready(function() {
		initReviewSliders(document);
	});
	// initialize slider in Elementor preview
