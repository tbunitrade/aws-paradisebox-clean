...
if (!class_exists('fuCurrency'))
{
  class fuCurrency
  {
    static public function GetSymbolEntity(string $currencyCode) : string
    {
      if (array_key_exists($currencyCode, fuCurrency::Data))
      {
        return fuCurrency::Data[$currencyCode]['entity'];
      }
      return "&curren;";
    }
