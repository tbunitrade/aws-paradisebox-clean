...
?><div class="subscription_scheme wc-metabox open" rel="<?php echo isset( $scheme_data['position'] ) ? esc_attr( $scheme_data['position'] ) : ''; ?>">
	...
	<div class="data subscription_scheme_data">
	<?php
	...
	if ( isset( $scheme_data['id'] ) ) {
		?>
		<input type="hidden" name="wcsatt_schemes[<?php echo absint( $index ); ?>][id]" class="scheme_id" value="<?php echo esc_attr( $scheme_data['id'] ); ?>" />
		<?php
	}
	?>
